...
<p style="font-size: 16px; font-family: Arial, sans-serif; color: #333;">Cảm ơn bạn đã đặt tour tại Fantatour. Vui lòng xem chi tiết hóa đơn trong file đính kèm.</p>
        ...
        <section class="content invoice">
            ...
            <div class="row invoice-info" style="margin-bottom: 20px;">
                ...
                <div class="col-sm-4 invoice-col" style="font-size: 14px;">
                    Đến
                    <address>
                        <strong>Fantatour</strong><br>
                        48/3/3A,đường số 3<br>
                        Trường thọ,Thủ đức,TP.HCM<br>
