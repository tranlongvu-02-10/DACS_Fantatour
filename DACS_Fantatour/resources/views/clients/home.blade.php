                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-12">
                            <div class="section-title text-center counter-text-wrap mb-70" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">
                                ...
                                <p>Một trang wed <span class="count-text plus" data-speed="3000" data-stop="34500">0</span> trải nghiệm phổ biến nhất</p>
                            </div>
                        </div>
                    </div>
                    <div class="container">
                    ...
                    <div class="col-xl-6">
                        <div class="features-content-part mb-55" data-aos="fade-left" data-aos-duration="1500" data-aos-offset="50">
                            <div class="section-title mb-60">
                                <h2>Trải nghiệm du lịch tuyệt đỉnh mang đến sự khác biệt cho fantatour chúng tôi</h2>
                            </div>
                            ...
                            <div class="testimonial-right-content" data-aos="fade-left" data-aos-duration="1500" data-aos-offset="50">
                                ...
                                <div class="testimonials-active">
                                    <div class="testimonial-item">
                                        ...
                                        <div class="text">"Chuyến đi của chúng tôi hoàn toàn hoàn hảo, cảm ơn công ty du lịch này! Họ chăm lo mọi chi tiết, từ chỗ ở, và thậm chí gợi ý những trải nghiệm tuyệt vời"</div>
                                        <div class="author">
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-4 col-md-6">
                        <div class="blog-item" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">
                            <div class="content">
                                ...
                                <h5><a href="blog-details.html">Hướng dẫn hoàn hảo để lập kế hoạch cho kỳ nghỉ trong mơ của bạn với fantatour</a></h5>
                                <ul class="blog-meta">
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="blog-item" data-aos="fade-up" data-aos-delay="50" data-aos-duration="1500" data-aos-offset="50">
                            <div class="content">
                                <a href="blog.html" class="category">Du lịch</a>
                                <h5><a href="blog-details.html">Những trải nghiệm trong danh sách mong muốn của công ty du lịch fantatour</a></h5>
                                <ul class="blog-meta">
                                    <li><i class="far fa-calendar-alt"></i> <a href="#">25 February 2024</a></li>
                                    <li><i class="far fa-comments"></i> <a href="#">Bình luận (5)</a></li>
                                </ul>
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="blog-item" data-aos="fade-up" data-aos-delay="100" data-aos-duration="1500" data-aos-offset="50">
                            <div class="content">
                                <a href="blog.html" class="category">Du lịch</a>
                                <h5><a href="blog-details.html">Khám phá Văn hóa và Ẩm thực Du lịch của Công ty Du lịch Điểm đến Ẩm thực</a></h5>
                                <ul class="blog-meta">
                                    <li><i class="far fa-calendar-alt"></i> <a href="#">25 February 2024</a></li>
                                    <li><i class="far fa-comments"></i> <a href="#">Bình luận (5)</a></li>
                                </ul>
