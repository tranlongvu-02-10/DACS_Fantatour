...
@include('clients.blocks.banner_home')
        ...
        <section class="destinations-area pt-100 pb-70 rel z-1" style="position: relative; overflow: hidden;">
            <!-- Nền Matrix Grid -->
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-12">
                        <div class="section-title text-white text-center counter-text-wrap mb-70" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">
                            <h2>Trải nghiệm và khám phá du lịch cùng tourista</h2>
                        </div>
                    </div>
                </div>
                <div class="row justify-content-center">
        ...
        <!-- About Us Area start -->
        <section class="about-us-area py-100 rpb-90 rel z-1" style="position: relative; overflow: hidden;">
            <!-- Nền Matrix Grid -->
            <div class="matrix-container">
                <div class="matrix-grid"></div>
            </div>
            ...
            <div class="container" style="position: relative; z-index: 10;">
                <div class="row align-items-center">
                    ...
                    <div class="about-us-content rmb-55" data-aos="fade-left" data-aos-duration="1500" data-aos-offset="50">
                        <h1 class="fw-bold mb-3" style="font-size: 3rem; line-height: 1.3; color: #ffffff;">
                            Khám Phá Những Câu Chuyện, <br> Mỗi Chuyến Đi
                        </h1>
                        <p class="mb-4" style="color: #e0e0e0;">
                            Địa điểm độc đáo cả trong và ngoài nước. Mang đến sự đa dạng để khách
                            hàng thoải mái lựa chọn chuyến đi cho riêng mình.
                        </p>

                        <!-- Nút mới với hiệu ứng lá cây -->
                        <a href="{{ route('destination') }}" class="plant-based-btn">
                            <button>
                                Khám phá Điểm đến
                                <div class="icon-1">
                ...
                <style>
                    ...
                    .plant-based-btn button {
                        ...
                        border-radius: 8px;
                        box-shadow:
                            2px 2px 5px #18181869,
                            inset 2px 2px 10px #ffffffb0;
                    ...
                    .plant-based-btn button:hover {
                        ...
                        box-shadow:
                            2px 2px 5px black,
                            inset 2px 2px 10px #5b3c11;
                    }

                    .plant-based-btn button:hover .icon-1 {
                        top: -250%;
                        left: 50%;
                        width: 50px;
                    ...
                    .plant-based-btn button:hover .icon-2 {
                        top: -200%;
                        left: 90%;
                        width: 75px;
                    ...
                    .plant-based-btn button:hover .icon-3 {
                        top: -130%;
                        left: 20%;
                        width: 60px;
                    ...
                    .plant-based-btn button:hover .icon-4 {
                        top: -300%;
                        left: 10%;
                        width: 85px;
                    ...
                    .plant-based-btn button:hover .icon-5 {
                        top: -350%;
                        left: 90%;
                        width: 85px;
        ...
        <section class="about-us-area py-100 rpb-90 rel z-1" style="position: relative; overflow: hidden;">
            ...
            <div class="container" style="position: relative; z-index: 10;">
                <div class="row align-items-center">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="counter-item counter-text-wrap">
                                        <span class="count-text k-plus" data-speed="3000" data-stop="3" style="color: #00ffaa;">0</span>
                                        <span class="counter-title" style="color: #ffffff;">Điểm đến phổ biến</span>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="counter-item counter-text-wrap">
                                        <span class="count-text m-plus" data-speed="3000" data-stop="9" style="color: #00ffaa;">0</span>
                                        <span class="counter-title" style="color: #ffffff;">Khách hàng hài lòng</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-7 col-lg-6" data-aos="fade-right" data-aos-duration="1500" data-aos-offset="50">
                        <img src="{{asset('clients/assets/images/features/anh.webp')}}" alt="features" style="width:100%; height:auto; border: 2px solid rgba(0, 255, 170, 0.3); border-radius: 10px;">
                    </div>
                </div>
            </div>
