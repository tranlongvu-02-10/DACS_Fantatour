                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="contact-info-item" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50" data-aos-delay="50">
                            ...
                            <div class="content">
                                ...
                                <div class="text"><i class="far fa-envelope"></i> <a href="mailto:longvu02102004@gmail.com">longvu02102004@gmail.com</a></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="contact-info-item" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50" data-aos-delay="50">
                            ...
                            <div class="content">
                                <h5>Chi nhánh HCM</h5>
                                <div class="text"><i class="fal fa-map-marker-alt"></i> 48/3/3A,đường số 3,Trường thọ,thủ đức,TP.HCM</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        ...
                        <div class="row mt-35">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="name" name="name" class="form-control" placeholder="Nguyen Van A" value="" required data-error="Vui lòng nhập tên của bạn">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="phone_number" name="phone_number" class="form-control" placeholder="Phone" value="" required data-error="Vui lòng nhập số điện thoại của bạn">
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="email" id="email" name="email" class="form-control" placeholder="enter email" value="" required data-error="Vui lòng nhập Email của bạn">
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="message" id="message" class="form-control" rows="5" placeholder="Message" required data-error="Vui lòng nhập tin nhắn của bạn"></textarea>
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
                            <div class="col-md-12">
