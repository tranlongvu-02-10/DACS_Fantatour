...
class ToursModel extends Model
{
    ...
    {
        return DB::table('tbl_imagess')->insert($data);
    }

    public function uploadTempImages($data)
    {
        return DB::table('tbl_temp_imagess')->insert($data);
    }

    public function addTimeLine($data)
    {
        return DB::table('tbl_timelinee')->insert($data);
    }
    ...
    public function deleteTour($tourId)
    {
        ...
        $deleteTimeLine = DB::table('tbl_timelinee')->where('tourId', $tourId)->delete();
        $deleteImages = DB::table('tbl_imagess')->where('tourId', $tourId)->delete();
    ...
    public function getImages($tourId){
        return DB::table('tbl_imagess')->where('tourId', $tourId)->get();
    }

    public function getTimeLine($tourId){
        return DB::table('tbl_timelinee')->where('tourId', $tourId)->get();
    }
